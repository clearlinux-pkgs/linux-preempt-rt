...
Group:          kernel
Source0:        https://cdn.kernel.org/pub/linux/kernel/v5.x/linux-5.10.8.tar.xz
Source1:        https://cdn.kernel.org/pub/linux/kernel/projects/rt/5.10/older/patch-5.10.8-rt24.patch.xz
Source2:        config
Source3:        cmdline
...
#Serie0.tag  v5.10.8-rt24-patches
#Serie0.start
Patch0000: patch-5.10.8-rt24.patch.xz
#Serie0.end
