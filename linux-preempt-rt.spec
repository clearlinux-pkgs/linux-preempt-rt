...
Source1:        https://cdn.kernel.org/pub/linux/kernel/projects/rt/5.4/patch-5.4.10-rt5.patch.xz
Source2:        config
Source3:        cmdline
...
#Serie0.tag  v5.4.10-rt5-patches
#Serie0.start
Patch0000: patch-5.4.10-rt5.patch.xz
#Serie0.end
