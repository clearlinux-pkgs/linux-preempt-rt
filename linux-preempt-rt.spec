...
Source1:        https://mirrors.kernel.org/pub/linux/kernel/projects/rt/5.10/patch-5.10.59-rt51.patch.xz
Source2:        config
Source3:        cmdline
...
#Serie0.tag  v5.10.59-rt51-patches
#Serie0.start
Patch0000: patch-5.10.59-rt51.patch.xz
#Serie0.end
