...
Source1:        https://cdn.kernel.org/pub/linux/kernel/projects/rt/5.4/patch-5.4.17-rt9.patch.xz
Source2:        config
Source3:        cmdline
...
#Serie0.tag  v5.4.17-rt9-patches
#Serie0.start
Patch0000: patch-5.4.17-rt9.patch.xz
#Serie0.end
